...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden max-w-3xl">
    <div class="p-6 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-500 mt-1">Ubah data master untuk item {{ $item->nama_barang }}.</p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode_barang" id="kode_barang" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('kode_barang', $item->kode_barang) }}" required placeholder="Contoh: BRG001">
                ...
                <div>
                    ...
                    <select name="rack_id" id="rack_id" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                        ...
                        @foreach($racks as $rack)
                            <option value="{{ $rack->id }}" {{ old('rack_id', $item->rack_id) == $rack->id ? 'selected' : '' }}>{{ $rack->nama_rak }} ({{ $rack->barcode }})</option>
                        @endforeach
                    </select>
            ...
            <div>
                ...
                <input type="text" name="nama_barang" id="nama_barang" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('nama_barang', $item->nama_barang) }}" required placeholder="Contoh: Pensil 2B">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="satuan" id="satuan" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('satuan', $item->satuan) }}" required placeholder="Contoh: Pcs, Box, Kg">
                ...
                <div>
                    ...
                    <input type="number" name="stok" id="stok" min="0" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('stok', $item->stok) }}" required>
            ...
            <div>
                ...
                <textarea name="keterangan" id="keterangan" rows="3" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('keterangan', $item->keterangan) }}</textarea>
