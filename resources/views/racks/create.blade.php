...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden max-w-3xl">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-xl font-bold text-gray-800">Tambah Rak Baru</h2>
        <p class="text-sm text-gray-500 mt-1">Masukkan informasi detail untuk rak penyimpanan baru.</p>
    </div>
    ...
    <form action="{{ route('racks.store') }}" method="POST" class="p-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nama_rak" id="nama_rak" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('nama_rak') }}" required>
            ...
            <div>
                ...
                <input type="text" name="barcode" id="barcode" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('barcode') }}" required placeholder="Contoh: RK001">
            ...
            <div>
                ...
                <input type="text" name="lokasi" id="lokasi" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="{{ old('lokasi') }}" placeholder="Contoh: Gudang A">
